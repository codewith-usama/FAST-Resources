...
{   
    printf(BOLDBLUE"\t\t*********************************************************************************************************************\n"RESET); sleep(1);
    printf(BOLDBLUE"\t\t**                                                                                                                 **\n"RESET); sleep(1);
    printf(BOLDBLUE"\t\t**	W      W      W   E E E E E E   L             C C C C C     O O O O O    M               M   E E E E E E   **\n"RESET); sleep(1);
    printf(BOLDBLUE"\t\t**	W     W W     W   E             L           C              O         O   M M           M M   E             **\n"RESET); sleep(1);
    printf(BOLDBLUE"\t\t**	W    W   W    W   E             L          C              O           O  M  M         M  M   E             **\n"RESET); sleep(1);
    printf(BOLDBLUE"\t\t**	W   W     W   W   E E E E E E   L          C              O           O  M   M       M   M   E E E E E E   **\n"RESET); sleep(1);
    printf(BOLDBLUE"\t\t**	W  W       W  W   E             L          C              O           O  M    M     M    M   E             **\n"RESET); sleep(1);
    printf(BOLDBLUE"\t\t**	W W         W W   E             L           C              O         O   M      M  M     M   E             **\n"RESET); sleep(1);
    printf(BOLDBLUE"\t\t**	W             W   E E E E E E   L L L L L     C C C C C     O O O O O    M        M      M   E E E E E E   **\n"RESET); sleep(1);
    printf(BOLDBLUE"\t\t**                                                                                                                 **\n"RESET); sleep(1);
    printf(BOLDBLUE"\t\t*********************************************************************************************************************\n"RESET); sleep(1);
    printf(GRN "\t\tTO USAMA AND FABIHA'S SHELL\n\n\n"RESET);
    ...
    {   
        ...
        */
        ...
        else 
        {
            ...
            {
                in = open(args[infile_index], O_RDONLY); // read only 
                if(in <0)
                {
            ...
            {
                out = open(args[outfile_index], O_WRONLY | O_APPEND); // write and append
                if(out <0)
                {
                    printf("Failed to open file with name %s \n", args[outfile_index]);
                    return 1;
...
void ParseCommand(char * command, char ** args)	// args:stores every arguement in a command
{
    ...
    // Space ki jaga NULL character to store kr k, NULL character count kren gy
...
void CheckForRedirection(char ** args)
{
    ...
    {
        //printf(" %d %s \n",i, args[i]);
        if(strcmp(args[i], "<") == 0) // for reading
        {
        ...
        if(strcmp(args[i], ">") ==0) // for writing
        {
